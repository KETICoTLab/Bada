...
public class BufferedRecords {
  ...
  public static HashMap<String, Object> keyChangeLowerMap(Map<String, Object> param) {
  ...
  public List<SinkRecord> flush() throws SQLException {
    ...
    for (SinkRecord record : records) {
      // Mobius con field
      Map<String, Object> conField = keyChangeLowerMap((Map<String, Object>) record.value());
