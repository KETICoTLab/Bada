...
app.get("/timeseries/:deviceID/:containerName/latest", (req, res) => {
  if (req.params.deviceID && req.params.containerName) {
    ...
    sql = `select * from ` + deviceID + ` where Container = '` + containerName + `' order by desc limit 1`;
    console.log(sql);
...
app.get("/timeseries/:deviceID/:containerName/period", (req, res) => {
  if (req.params.deviceID && req.params.containerName && req.query.from && req.query.to) {
    let { deviceID, containerName } = req.params;
    var startdatetime = moment(req.query.from) / 0.000001;
    var enddatetime = moment(req.query.to) / 0.000001;
    sql = `select * from ` + deviceID + ` where time >= ` + startdatetime + ` and time <= ` + enddatetime + ` and Container = '` + containerName + `'`;
...
app.get("/timeseries/:deviceID/:containerName/average", (req, res) => {
  if (req.params.deviceID && req.params.containerName && req.query.date) {
    ...
    sql = `select mean(*) from ` + deviceID + ` where Container = '` + containerName + `' and time >= ` + startdatetime + ` and time <= ` + enddatetime + ``;
    console.log(sql);
...
app.get("/timeseries/:deviceID/:containerName/min", (req, res) => {
  if (req.params.deviceID && req.params.containerName && req.query.date) {
    ...
    sql = `select min(*) from ` + deviceID + ` where Container = '` + containerName + `' and time >= ` + startdatetime + ` and time <= ` + enddatetime + ``;
    console.log(sql);
...
app.get("/timeseries/:deviceID/:containerName/max", (req, res) => {
  if (req.params.deviceID && req.params.containerName && req.query.date) {
    ...
    sql = `select max(*) from ` + deviceID + ` where Container = '` + containerName + `' and time >= ` + startdatetime + ` and time <= ` + enddatetime + ``;
    console.log(sql);
