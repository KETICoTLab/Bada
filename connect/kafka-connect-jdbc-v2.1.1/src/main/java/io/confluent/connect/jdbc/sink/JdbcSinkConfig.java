...
public class JdbcSinkConfig extends AbstractConfig {
  ...
  private static final String REDIS_URL_DOC = "Redis connection URL.\n"
          + "For example: ``localhost`` (5432 port default) ";
  private static final String REDIS_URL_DISPLAY = "REDIS URL";
  private static final String REDIS_URL_DEFAULT = "localhost";


  public static final String KAFKA_URL = "kafka.url";
  private static final String KAFKA_URL_DOC = "KAFKA connection URL.\n"
          + "For example: ``localhost:9092``";
  private static final String KAFKA_URL_DISPLAY = "KAFKA URL";
  private static final String KAFKA_URL_DEFAULT = "localhost:9092";
